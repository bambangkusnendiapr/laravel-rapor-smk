                      ...
                      <tbody>
                          ...
                          @else
                              @foreach($major as $key => $data)
                                  <tr>
                                      <td class="text-center">{{ $major->firstItem() + $key }}</td>
        ...
        <form wire:submit.prevent="createData">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input wire:model.defer="state.jurusan" required type="text" class="form-control @error('jurusan') is-invalid @enderror" id="jurusan" placeholder="Jurusan" autofocus>
              @error('jurusan')
      ...
      <div class="modal-content">
        ...
        <form wire:submit.prevent="updateData">
          <div class="modal-body">
            <div class="form-group">
                <label for="jurusan">Jurusan</label>
                <input wire:model.defer="state.jurusan" required type="text" class="form-control @error('jurusan') is-invalid @enderror" id="jurusan" autofocus>
                @error('jurusan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
