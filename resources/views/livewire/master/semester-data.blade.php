                      ...
                      <tbody>
                          ...
                          @else
                              @foreach($semester as $key => $data)
                                  <tr>
                                      <td class="text-center">{{ $semester->firstItem() + $key }}</td>
                                      <td class="text-center">{{ $data->nama }}</td>
                                      <td class="text-center">{{ $data->tahun }}</td>
                                      <td class="text-center">{{ $data->aktif == 1 ? 'Aktif':'Tidak Aktif' }}</td>
        ...
        <form wire:submit.prevent="createData">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input wire:model.defer="state.tahun" required type="text" class="form-control @error('tahun') is-invalid @enderror" id="tahun" placeholder="Tahun, cth: 2020/2021">
              @error('tahun')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="form-group">
              ...
              <select wire:model.defer="state.aktif" required class="form-control @error('aktif') is-invalid @enderror" id="aktif">
