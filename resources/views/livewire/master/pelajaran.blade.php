                      ...
                      <tbody>
                          ...
                          @else
                              @foreach($lesson as $key => $data)
                                  <tr>
                                      <td class="text-center">{{ $lesson->firstItem() + $key }}</td>
                                      <td class="text-center">{{ $data->kode }}</td>
                                      <td class="text-center">{{ $data->nama }}</td>
                                      <td class="text-center">{{ $data->kelas }}</td>
                                      <td class="text-center">{{ $data->group->nama }}</td>
        ...
        <form wire:submit.prevent="createData">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input wire:model.defer="state.kode" required type="text" class="form-control @error('kode') is-invalid @enderror" id="kode" placeholder="kode" autofocus>
              @error('kode')
            ...
            <div class="form-group">
              <label for="jenis">Jenis / Kelompok Pelajaran</label>
              <select wire:model.defer="state.jenis" required class="form-control @error('jenis') is-invalid @enderror">
