                ...
                <div class="table-responsive-sm">
                  <table class="table table-sm table-striped mt-1">
                      ...
                      <tbody>
                          ...
                          @else
                              @foreach($prestasi as $key => $data)
                                <tr>
                                    <td class="text-center">{{ $prestasi->firstItem() + $key }}</td>
                                    <td class="text-center">{{ $data->prestasi }}</td>
        ...
        <form wire:submit.prevent="createData">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input wire:model.defer="state.prestasi" type="text" id="prestasi" required class="form-control @error('prestasi') is-invalid @enderror" placeholder="Jenis Prestasi"/>
                @error('prestasi')
            ...
            <div class="form-group">
              ...
              <textarea wire:model.defer="state.ket" id="ket" required class="form-control @error('ket') is-invalid @enderror" placeholder="Keterangan"></textarea>
                @error('ket')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
