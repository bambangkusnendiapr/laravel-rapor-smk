...
<div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mata Pelajaran Guru</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin</a></li>
              <li class="breadcrumb-item"><a href="#">Kelola Data Guru</a></li>
              <li class="breadcrumb-item active">Mata Pelajaran Guru</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                ...
                <div class="table-responsive-sm">
                  <table class="table table-sm table-striped mt-1">
                      ...
                      <tbody>
                          @if($pelajaran_guru->isEmpty())
                              <tr>
                                      <td colspan="7" class="text-center font-italic text-danger"><h5>-- Data Tidak Ditemukan --</h5></td>
                              </tr>
                          @else
                              @foreach($pelajaran_guru as $key => $data)
                                <tr>
                                    <td class="text-center">{{ $pelajaran_guru->firstItem() + $key }}</td>
                                    <td class="text-center">{{ $data->teacher->kode }}</td>
                                    <td class="text-center">{{ $data->teacher->user->name }}</td>
                                    <td class="text-center">{{ $data->lesson->nama }}</td>
