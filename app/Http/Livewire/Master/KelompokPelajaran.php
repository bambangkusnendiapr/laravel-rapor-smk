...
class KelompokPelajaran extends Component
{
    public $state = [];
    public $idHapus = null;
    public $idEdit = null;
    ...
    {
        return view('livewire.master.kelompok-pelajaran', [
            'group' => Group::where('nama', 'like', '%'.$this->search.'%')->paginate($this->paginate)
        ]);
    }
